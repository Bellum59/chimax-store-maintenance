...
class ProduitDAO {
	public static function listerProduits($order) {
        ...
        $requete = $basededonnees->prepare("SELECT id, nom, description, prix, idCategorie, imageId FROM article ORDER BY $order");
        $requete->execute();
