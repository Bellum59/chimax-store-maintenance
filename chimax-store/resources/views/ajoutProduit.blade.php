...
<form action="index.html" id="ModificationProduit">
      ...
      <div class="row">
        <div class="col-sm-5 bg-light text-center">
          ...
          <div class="form-group">
            <label for="ajouterImageProduit">Remplacer cette image :</label>
            <input type="file" class="form-control-file" id="ajouterImageProduit">
          </div> 
        </div>
    ...
    <div class="container mt-5">
      <div class="row mr-auto justify-content-center">
        ...
        <div class="col-sm-3 text-center">
          <button type="submit" class="btn btn-success btn-lg">Creer produit</button>
        </div>
      </div>
    </div>
    </form>
