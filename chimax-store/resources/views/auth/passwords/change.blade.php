    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/index.php/password/change">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="new-password" class="col-md-4 col-form-label text-md-end">Nouveau mot de passe</label>
                        ...
                        <div class="row mb-3">
                            <label for="new-password-confirm" class="col-md-4 col-form-label text-md-end">Confirmer le mot de passe</label>
